    ...
    public function configurationParameterError()
    {
        ...
        $configError = array(
                "error" => array("code" => 412,
                        "details" => array("Detected malformed 'mustMatch' property in the configuration file. The server does not meet one of the preconditions that the requester put on the request. ".$this->proxyConfig['mustmatch']),
