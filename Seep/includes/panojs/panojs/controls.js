...
PanoJS.CONTROL_IMAGE_ZOOMIN   = "/Seep/includes/panojs/images/32px_plus.png";
PanoJS.CONTROL_IMAGE_ZOOM11   = "/Seep/includes/panojs/images/32px_11.png";
PanoJS.CONTROL_IMAGE_ZOOMOUT  = "/Seep/includes/panojs/images/32px_minus.png";
PanoJS.CONTROL_IMAGE_MAXIMIZE = "/Seep/includes/panojs/images/32px_show.png";

PanoJS.CONTROL_IMAGE_ZOOMIN_TOUCH   = "/Seep/includes/panojs/images/64px_plus.png";
PanoJS.CONTROL_IMAGE_ZOOM11_TOUCH   = "/Seep/includes/panojs/images/64px_11.png";
PanoJS.CONTROL_IMAGE_ZOOMOUT_TOUCH  = "/Seep/includes/panojs/images/64px_minus.png";
PanoJS.CONTROL_IMAGE_MAXIMIZE_TOUCH = "/Seep/includes/panojs/images/64px_show.png";

// z-index changed for app

PanoJS.CONTROL_STYLE = "position: absolute; z-index: 1030; "; //opacity:0.5; filter:alpha(opacity=50); ";
