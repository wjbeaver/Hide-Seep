...
struct HistogramInternal {
  DIM_UINT16 data_bpp; // bits per pixel  
  DIM_UINT16 data_fmt; // signed, unsigned, float
  double shift;
  double scale;
  double value_min; 
  double value_max;
...
class DimHistogram {
  public:
    typedef DIM_UINT64 StorageType; 
    ...
    D_DataFormat dataFormat() const { return (D_DataFormat) d.data_fmt; }
