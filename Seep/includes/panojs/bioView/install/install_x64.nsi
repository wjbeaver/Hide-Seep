...
; The file to write
OutFile "..\distr\bioview_win64_1-1-18.exe"
...
ComponentText "This will install bioView 1.1.18 for Win64 on your computer. Select which optional things you want installed."
; The text to prompt the user to enter a directory
