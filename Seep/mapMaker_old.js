        ...
        require([
            ...
            function (Map,
                ...
                map.addLayers([seepFeatureLayer, seepImagesFeatureLayer, seepNameObjectLayer, seepExistingSpringsLayer]);
                ...
                // called from dialog that gets coordinates
                addSpringFromCoords = function (coords) {
                    console.log("Coordinates passed: " + coords.signature);

                    // create a point for a spring

                    // collect attributes and save

                    // images uploader
                    dialog_image_loader.setLongitude(coords.longitude);
                    dialog_image_loader.setLatitude(coords.latitude);
                    dialog_image_loader.show();

                    // collect image attributes

                    // save to image feature
                }
            });